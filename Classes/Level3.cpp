...
cocos2d::Scene * Level3::createScene(bool musicOn) {
...
void Level3::setup(bool musicOn) {
	if (musicOn)
		AudioEngine::play2d(LEVEL3_BG_MUSIC, true);
	...
	{ 0 ,					  totalSize.height * 0.2f },
	{ totalSize.width * 0.1f, totalSize.height * 0.2f },
	{ totalSize.width * 0.2f, totalSize.height * 0.7f },
	{ totalSize.width * 0.3f, totalSize.height * 0.2f },
	{ totalSize.width * 0.4f, totalSize.height * 0.7f },
	{ totalSize.width * 0.5f, totalSize.height * 0.2f },
	{ totalSize.width * 0.6f, totalSize.height * 0.7f },
	{ totalSize.width * 0.7f, totalSize.height * 0.2f },
	{ totalSize.width * 0.8f, totalSize.height * 0.7f },
	{ totalSize.width * 0.9f, totalSize.height * 0.2f },
	{ totalSize.width,		  totalSize.height * 0.7f },
	};
	...
	enemies[0].moveToX(totalSize.width * 0.3f);
